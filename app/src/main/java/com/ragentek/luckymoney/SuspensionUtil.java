...
/**
 * Created by sherry on 2017/1/25.
 */

public class SuspensionUtil {
    private static final String TAG="SuspensionUtil";
...
//   ComponentName comp = new ComponentName("com.android.settings","com.android.settings.permission.single_app_activity");//此处可跳转到指定app对应的权限管理页面，但是需要相关权限，未解决
    ...
    /**
     * 1、用checkFloatWindowPermission和checkOp检测 miui 悬浮窗权限
     * 2、获取小米 rom 版本号，获取失败返回 -1（每个版本打开权限的方式不一样）
     *
